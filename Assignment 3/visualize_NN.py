...
def buildGraph():
    ...
    return X, Y, cross_entropy_loss, class_error, train
...
def visualization(W, percent):
    ...
    f.savefig("1_4_2_wo_dropout" + str(percent) + ".png")
    plt.show()
...
# Train
X, Y, ce_loss, error, train = buildGraph()
...
for train_step in range(num_train_steps):
    ...
    if ((cur_epoch + 1) == int(0.25 *early_stop)):
        saver.save(sess, './regular_NN_0.25',global_step=25)
